...
class StudentScoreList extends StatefulWidget {
  const StudentScoreList({Key? key}) : super(key: key);

  @override
  _StudentScoreListState createState() => _StudentScoreListState();
}

class _StudentScoreListState extends State<StudentScoreList> {
  Future<List<StudentBriefModel>>? students;
  final studentListKey = GlobalKey<_StudentScoreListState>();
  int _banValue = 0;
  int _gradeValue = 1;
  ...
  Future<List<StudentBriefModel>> getStudentList(
    ...
    var url = Uri.parse("http://pjef.org/api/get_student_score_list1.php");
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (int index) {
          if (index == 0) {
            ...
            Get.offNamed('/studentPhotoList/value?grade=$_gradeValue&ban=$_banValue');
          }
        },
        items: const [
